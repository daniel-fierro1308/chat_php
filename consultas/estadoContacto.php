 <?php
	if(isset($_POST['verificarContacto'])){
		...
		if($_SESSION['preguntar']==true){
			...
			$error1="<div class='alert alert-danger'>Error al seleccionar los contactos on</div>";		
			...
			if($_SESSION['numContactos2']!=0){
				...
				$error2="<div class='alert alert-danger'>Error al seleccionar los contactos on segunda consulta</div>";
			...
			$error1="<div class='alert alert-danger'>Error al seleccionar los contactos</div>";		
			$contactos=consulta($con,$sql1,$error1);
			...
			if($_SESSION['numContactos2']!=0){
				...
				$error2="<div class='alert alert-danger'>Error al seleccionar los contactos en segunda consulta</div>";
				$contactos2=consulta($con,$sql2,$error2);
