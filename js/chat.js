...
function guardarMensaje(){
	if(conexion.readyState==4){
		...
		mensajesAjax2.innerHTML='<div class="alert alert-info">Enviando...</div>';
	}
}
function mostrarMensajes(){
	if(conexion.readyState==4){
		...
		mensajesAjax.innerHTML='<div class="alert alert-info">Cargando conversacion...</div>';
	}
}
function tiempo(){
    setTimeout(function(){
        document.getElementById('mensajesAjax2').innerHTML = "";
    },2000);
}